...
router.post('/pickingproductos', async (req,res)=>{
    ...
    let qry = `
    SELECT ME_Documentos.DOC_NUMORDEN AS EMBARQUE, ME_Embarques.NomRuta AS RUTA, 
        ME_Docproductos.CODPROD, ME_Productos.DESPROD, 
        SUM(ME_Docproductos.CANTIDADINV) AS TOTALUNIDADES, 
        ME_Productos.EQUIVALEINV AS UXC, 
        (SUM(ME_Docproductos.CANTIDADINV) / ME_Productos.EQUIVALEINV) AS CAJAS, 
    ...
    FROM ME_Embarques RIGHT OUTER JOIN
        ME_Documentos ON ME_Embarques.Codigo = ME_Documentos.DOC_NUMORDEN AND ME_Embarques.EmpNit = ME_Documentos.EMP_NIT AND 
        ME_Embarques.CODSUCURSAL = ME_Documentos.CODSUCURSAL LEFT OUTER JOIN
        ME_Productos RIGHT OUTER JOIN
        ME_Docproductos ON ME_Productos.CODPROD = ME_Docproductos.CODPROD AND ME_Productos.EMP_NIT = ME_Docproductos.EMP_NIT ON ME_Documentos.CODSUCURSAL = ME_Docproductos.CODSUCURSAL AND 
        ME_Documentos.DOC_ANO = ME_Docproductos.DOC_ANO AND ME_Documentos.DOC_NUMERO = ME_Docproductos.DOC_NUMERO AND ME_Documentos.CODDOC = ME_Docproductos.CODDOC AND 
        ME_Documentos.EMP_NIT = ME_Docproductos.EMP_NIT
