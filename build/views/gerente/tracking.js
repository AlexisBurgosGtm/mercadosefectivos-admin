        ...
        encabezado : ()=>{
            ...
            <div class="row">
                <div id="panel-1" class="panel col-12">
                    <div class="panel-hdr">
                        <h2>Seleccione Sucursal, Mes y Año</h2>                  
        ...
        gpsventas: ()=>{
            ...
            <div class="row">
                ...
                <div id="panel-3" class="panel col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="panel-container">
                        <select id="cmbTipoEmpleado" class="form-control col-sm-12 col-md-5 col-lg-5 col-xl-5"></select>
                        <div class="panel-content">
...
function Lmap(lat,long,nombre,telefono,horamin){
    //INICIALIZACION DEL MAPA            
      ...
      L.marker([lat, long])
        .addTo(map)
        .bindPopup(`${nombre} - <br>Tel:${telefono} - Updated:${horamin} hrs`, {closeOnClick: false, autoClose: false})
        .openPopup()
      return map;
};
...
async function addListeners(){
    ...
    cmbSucursal.addEventListener('change',async()=>{
        GlobalCodSucursal = cmbSucursal.value;
        await cargarDatos(cmbTipoDatos.value);
    })
    ...
    let cmbTipoEmpleado = document.getElementById('cmbTipoEmpleado')
    funciones.getComboTipoEmpleados('cmbTipoEmpleado');
    cmbTipoEmpleado.addEventListener('change',async()=>{
        await api.gerenteStatusGpsVentas('rootUbicaciones',cmbTipoEmpleado.value);
    })
...
async function cargarDatos(tipodato){
    ...
    switch (tipodato) {
        case 'DIA':
            await api.gerenteRankingVendedores(funciones.devuelveFecha('txtFecha'),'rootVendedores','lbTotalVendedores');
            await api.gerenteMarcas(funciones.devuelveFecha('txtFecha'),'rootMarcas','lbTotalMarcas');
            break;
        case 'MES':
            await api.gerenteRankingVendedoresMes(cmbAnio.value,cmbMes.value,'rootVendedores','lbTotalVendedores');
            await api.gerenteMarcasMes(cmbAnio.value,cmbMes.value,'rootMarcas','lbTotalMarcas');
            break;
        default:
            break;
    }
...
function InicializarVistaGerenteTracking(){
